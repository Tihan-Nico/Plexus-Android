...
import com.plexus.R;
import com.plexus.core.utils.ResourceUtil;
...
public final class SupportEmailUtil {
    ...
    private static CharSequence getRegistrationLockEnabled(@NonNull Context context) {
        return String.valueOf(PlexusPreferences.isV1RegistrationLockEnabled(context) || PlexusStore.kbsValues().isV2RegistrationLockEnabled());
    }*/
}
