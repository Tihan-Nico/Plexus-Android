package com.plexus.utils.livedata;
...
import com.plexus.core.utils.guava.Function;
import com.plexus.utils.concurrent.SerialMonoLifoExecutor;
...
public final class LiveDataUtil {
    ...
    /**
     * Runs the {@param backgroundFunction} on {@link com.plexus.core.utils.concurrent.PlexusExecutors#BOUNDED}.
     * <p>
    ...
    public static <A, B> LiveData<B> mapAsync(@NonNull LiveData<A> source, @NonNull Function<A, B> backgroundFunction) {
        return mapAsync(PlexusExecutors.BOUNDED, source, backgroundFunction);
    }
