...
import com.plexus.R;
import com.plexus.database.NoExternalStorageException;
...
public class StorageUtil {
    ...
    private static final String PRODUCTION_PACKAGE_ID = "com.plexus";
    ...
    public static boolean canWriteToMediaStore() {
        return Build.VERSION.SDK_INT > 28 ||
                Permissions.hasAll(PlexusDependencies.getApplication(), Manifest.permission.WRITE_EXTERNAL_STORAGE);
    }

    public static boolean canReadFromMediaStore() {
        return Permissions.hasAll(PlexusDependencies.getApplication(), Manifest.permission.READ_EXTERNAL_STORAGE);
    }
