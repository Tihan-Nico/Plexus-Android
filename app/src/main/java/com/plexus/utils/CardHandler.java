...
public class CardHandler {
    ...
    public String BankName(String cardNo, Context context){
        if(CardValidation(cardNo) == true){
            if(banks.containsKey(cardNo.substring(0,6))){
                ...
                Toast.makeText(context,R.string.plexus_pay_card_not_supported,Toast.LENGTH_SHORT).show();
                return null;
            }

        }else {
            Toast.makeText(context, R.string.plexus_pay_card_not_valid,Toast.LENGTH_SHORT).show();
            return null;
        }
    ...
    public int BankLogo(String bankName, Context context){
        ...
        if(banksLogo.containsKey(bankName)){
            ...
            Toast.makeText(context,R.string.plexus_pay_bank_not_support,Toast.LENGTH_SHORT).show();
            return 0;
        }
