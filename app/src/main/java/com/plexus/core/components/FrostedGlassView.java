package com.plexus.core.components;
...
public class FrostedGlassView extends RelativeLayout {
    ...
    public FrostedGlassView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FrostedGlassView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void initAttributes(AttributeSet attrs) {
        TypedArray typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.FrostedGlassView);
        mDownSampling = typedArray.getInt(R.styleable.FrostedGlassView_downSampling, DEFAULT_DOWN_SAMPLING);
        setBlurRadius(typedArray.getFloat(R.styleable.FrostedGlassView_blurRadius, DEFAULT_BLUR_RADIUS));
        typedArray.recycle();
    }
