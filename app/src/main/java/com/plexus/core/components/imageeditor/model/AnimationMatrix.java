...
import com.plexus.core.components.imageeditor.CanvasMatrix;
...
final class AnimationMatrix {
    ...
    static @NonNull
    AnimationMatrix animate(@NonNull Matrix from, @NonNull Matrix to, @Nullable Runnable invalidate) {
        if (invalidate == null) {
            return NULL;
        }
     ...
     */
    static @NonNull
    AnimationMatrix singlePulse(@NonNull Matrix pulse, @Nullable Runnable invalidate) {
        if (invalidate == null) {
            return NULL;
        }
