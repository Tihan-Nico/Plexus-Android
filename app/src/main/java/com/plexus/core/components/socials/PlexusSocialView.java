...
public interface PlexusSocialView {
    ...
    interface OnClickListener {
         ...
         */
        void onClick(@NonNull PlexusSocialView view, @NonNull CharSequence text);
    }
    ...
    interface OnChangedListener {
         ...
         */
        void onChanged(@NonNull PlexusSocialView view, @NonNull CharSequence text);
    }
