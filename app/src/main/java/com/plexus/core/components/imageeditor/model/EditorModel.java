package com.plexus.core.components.imageeditor.model;
...
import com.plexus.core.components.imageeditor.ColorableRenderer;
import com.plexus.core.components.imageeditor.Renderer;
import com.plexus.core.components.imageeditor.RendererContext;
import com.plexus.core.components.imageeditor.UndoRedoStackListener;
import com.plexus.core.components.imageeditor.renderers.FaceBlurRenderer;
import com.plexus.core.components.imageeditor.renderers.MultiLineTextRenderer;
...
public final class EditorModel implements Parcelable, RendererContext.Ready {
  ...
  public @Nullable
  Matrix findElementInverseMatrix(@NonNull EditorElement element, @NonNull Matrix viewMatrix) {
  ...
  private @Nullable
  Matrix findElementMatrix(@NonNull EditorElement element, @NonNull Matrix viewMatrix) {
  ...
  @WorkerThread
  public @NonNull
  Bitmap render(@NonNull Context context) {
  ...
  @WorkerThread
  public @NonNull
  Bitmap render(@NonNull Context context, @Nullable Point size) {
  ...
  public @Nullable
  EditorElement findById(@NonNull UUID uuid) {
