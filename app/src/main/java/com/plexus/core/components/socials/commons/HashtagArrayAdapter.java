...
public class HashtagArrayAdapter<T extends Hashtagable> extends SocialArrayAdapter<T> {
    ...
    public HashtagArrayAdapter(@NonNull Context context, @PluralsRes int countPluralRes) {
        super(context, R.layout.post_hashtag_layout, R.id.socialview_hashtag);
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.post_hashtag_layout, parent, false);
