...
public class PlexusSocialTextView extends AppCompatTextView implements PlexusSocialView {
    private final PlexusSocialViewHelper helper;

    public PlexusSocialTextView(Context context) {
        this(context, null);
    }

    public PlexusSocialTextView(Context context, AttributeSet attrs) {
        this(context, attrs, android.R.attr.textViewStyle);
    }

    public PlexusSocialTextView(Context context, AttributeSet attrs, int defStyleAttr) {
