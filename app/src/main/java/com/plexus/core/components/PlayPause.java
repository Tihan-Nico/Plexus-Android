...
//  }
    ...
    /**
     * 回転状況を {@link PlayPause.SavedState} に保存する
     * {@inheritDoc}
     */
    @Override
    ...
    /**
     * Restoreしてきたやつから {@link PlayPause.SavedState}
     * を取得し状況をセットする
     * {@inheritDoc}
     */
    @Override
    ...
    /**
     * {@link PlayPause#mPlayed} を返す
     *
     * @return {@link PlayPause#mPlayed}
     */
    ...
    /**
     * {@link PlayPause#mBackgroundColor} をセットして再描画する
     *
     * @param color セットする色
     */
