package com.plexus.core.providers;
...
public class SearchDatabase {
    ...
    private static SearchDatabase sInstance = null;

    private PlexusDatabase mDatabase = null;

    public SearchDatabase(final Context context) {
        mDatabase = PlexusDatabase.getInstance(context);
    }

    public static final synchronized SearchDatabase getInstance(final Context context) {
        if (sInstance == null) {
