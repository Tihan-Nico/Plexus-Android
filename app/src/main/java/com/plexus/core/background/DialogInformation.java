...
public class DialogInformation {
    ...
    public static void getNotificationDescription(Notification notification, TextView notification_description, String publisherid){
    ...
    public static void showNotificationBottomSheet(Context context, Notification notification, String profileid){
        ...
        getNotificationDescription(notification, notification_description, profileid);
        getProfileImage(profileid, profile_image, context);

        delete_notification.setOnClickListener(v -> {
            PlexusDelete.deleteNotification(notification.getId());
