...
import com.plexus.slides.AudioSlide;
...
public final class AudioWaveForm {
    ...
    private static final Executor                        AUDIO_DECODER_EXECUTOR = new SerialExecutor(PlexusExecutors.BOUNDED);
