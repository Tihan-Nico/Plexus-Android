...
import com.plexus.utils.FloatProperty;
import com.plexus.utils.IntProperty;
...
public class PropertyValuesHolder implements Cloneable {
    ...
    public static PropertyValuesHolder ofKeyframe(String propertyName, Keyframe... values) {
        ...
        if (keyframeSet instanceof KeyframeSet) {
            return new IntPropertyValuesHolder(propertyName, (KeyframeSet) keyframeSet);
    ...
    public static PropertyValuesHolder ofKeyframe(Property property, Keyframe... values) {
        KeyframeSet keyframeSet = KeyframeSet.ofKeyframe(values);
        if (keyframeSet instanceof KeyframeSet) {
            return new IntPropertyValuesHolder(property, (KeyframeSet) keyframeSet);
        } else if (keyframeSet instanceof FloatKeyframeSet) {
    ...
    static class IntPropertyValuesHolder extends PropertyValuesHolder {
        ...
        KeyframeSet mIntKeyframeSet;
        int mIntAnimatedValue;

        public IntPropertyValuesHolder(String propertyName, KeyframeSet keyframeSet) {
            super(propertyName);
            mValueType = int.class;
            mKeyframeSet = keyframeSet;
            mIntKeyframeSet = (KeyframeSet) mKeyframeSet;
        }

        public IntPropertyValuesHolder(Property property, KeyframeSet keyframeSet) {
            super(property);
            mValueType = int.class;
            mKeyframeSet = keyframeSet;
            mIntKeyframeSet = (KeyframeSet) mKeyframeSet;
        ...
        public IntPropertyValuesHolder clone() {
            ...
            newPVH.mIntKeyframeSet = (KeyframeSet) newPVH.mKeyframeSet;
            return newPVH;
        }
