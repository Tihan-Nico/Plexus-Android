...
import com.plexus.settings.helper.license.internal.GitHubLibrary;
import com.plexus.settings.helper.license.internal.NoContentLibrary;
import com.plexus.settings.helper.license.internal.NoLinkLibrary;
...
public final class Licenses {
    /**
     * The Apache license 2.0 name to be used with .
     *
     * @see #NAME_MIT
     * @see #NAME_BSD
     * @see #NAME_UNKNOWN
    ...
    /**
     * The MIT license name to be used with .
     *
     * @see #NAME_APACHE_V2
     * @see #NAME_BSD
     * @see #NAME_UNKNOWN
    ...
    /**
     * The BSD 3-clause license name to be used with .
     *
     * @see #NAME_APACHE_V2
     * @see #NAME_MIT
     * @see #NAME_UNKNOWN
