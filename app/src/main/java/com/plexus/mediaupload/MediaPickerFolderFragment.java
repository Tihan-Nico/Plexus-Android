...
public class MediaPickerFolderFragment extends Fragment implements MediaPickerFolderAdapter.EventListener {
    ...
    public static @NonNull MediaPickerFolderFragment newInstance(@NonNull Context context, @Nullable User recipient) {
        return newInstance(context, recipient, false, false);
    }

    public static @NonNull MediaPickerFolderFragment newInstance(@NonNull Context context, @Nullable User recipient, boolean hideCamera, boolean isChat) {
        String toolbarTitle = "";
