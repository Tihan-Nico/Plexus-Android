        ...
        Camera1Controller.EventListener
{
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        camera        = new Camera1Controller(PlexusPreferences.getDirectCaptureCameraId(getContext()), displaySize.x, displaySize.y, this);
        ...
        orderEnforcer.run(Stage.CAMERA_PROPERTIES_AVAILABLE, () -> {
            if (properties.getCameraCount() > 1) {
                ...
                flipButton.setOnClickListener(v ->  {
                    ...
                    PlexusPreferences.setDirectCaptureCameraId(getContext(), newCameraId);
