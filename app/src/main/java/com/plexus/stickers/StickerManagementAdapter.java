...
import com.plexus.GlideRequests;
import com.plexus.R;
import com.plexus.components.emoji.EmojiTextView;
import com.plexus.crypto.media.DecryptableStreamUriLoader;
import com.plexus.database.model.StickerPackRecord;
import com.plexus.glide.cache.ApngOptions;
import com.plexus.utils.SectionedRecyclerViewAdapter;
import com.plexus.utils.StableIdGenerator;
...
final class StickerManagementAdapter extends SectionedRecyclerViewAdapter<String, StickerManagementAdapter.StickerSection> {
    ...
    private static final String TAG_MESSAGE_STICKERS = "PlexusStickers";
    ...
    static class StickerViewHolder extends RecyclerView.ViewHolder {
                  ...
                  boolean allowApngAnimation)
        {
            ...
            if (stickerPack.isInstalled()) {
                actionButtonImage.setImageResource(R.drawable.close);
                ...
                actionButtonImage.setImageResource(R.drawable.drop_down_arrow);
        ...
        private static @NonNull CharSequence buildBlessedBadge(@NonNull Context context) {
            ...
            Drawable        badge     = ContextCompat.getDrawable(context, R.drawable.ic_check);

            badge.setBounds(0, 0, badge.getIntrinsicWidth(), badge.getIntrinsicHeight());
            badge.setColorFilter(ContextCompat.getColor(context, R.color.plexus), PorterDuff.Mode.MULTIPLY);
