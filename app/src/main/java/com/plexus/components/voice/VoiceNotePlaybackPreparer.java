...
final class VoiceNotePlaybackPreparer implements MediaSessionConnector.PlaybackPreparer {
    ...
    private @NonNull
    MediaDescriptionCompat createEndClone(@NonNull MediaDescriptionCompat source) {
        return buildUpon(source).setMediaId("end").setMediaUri(END_URI).build();
    }

    private @NonNull
    MediaDescriptionCompat createNextClone(@NonNull MediaDescriptionCompat source) {
        return buildUpon(source).setMediaId("next").setMediaUri(NEXT_URI).build();
    }

    private @NonNull
    MediaDescriptionCompat.Builder buildUpon(@NonNull MediaDescriptionCompat source) {
    ...
    private @NonNull
    List<MediaDescriptionCompat> loadMediaDescriptionForSinglePlayback(long messageId) {
        /*try {
    ...
    @WorkerThread
    private @NonNull
    List<MediaDescriptionCompat> loadMediaDescriptionsForConsecutivePlayback(long messageId) {
        /*try {
