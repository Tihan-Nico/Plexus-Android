package com.plexus.components.components.videoView;
...
import com.plexus.R;
import com.plexus.utils.AnimationUtils;
import com.plexus.utils.MediaTimeUtils;
...
public class VideoControlView extends FrameLayout {
    ...
    void initSubviews() {
        ...
        inflater.inflate(R.layout.post_video_control, this);

        stateControl = findViewById(R.id.state_control);
    ...
    void setPlayDrawable() {
        stateControl.setImageResource(R.drawable.video_play_btn);
        stateControl.setContentDescription(getContext().getString(R.string.play));
    }

    void setPauseDrawable() {
        stateControl.setImageResource(R.drawable.video_pause_btn);
        stateControl.setContentDescription(getContext().getString(R.string.pause));
    }

    void setReplayDrawable() {
        stateControl.setImageResource(R.drawable.video_replay_btn);
        stateControl.setContentDescription(getContext().getString(R.string.replay));
    }
