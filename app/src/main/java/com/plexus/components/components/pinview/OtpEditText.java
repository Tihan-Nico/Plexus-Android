package com.plexus.components.components.pinview;
...
public class OtpEditText extends AppCompatEditText implements TextWatcher {
    ...
    private void getAttrsFromTypedArray(AttributeSet attributeSet) {
        ...
        mSecondaryColor = a.getColor(R.styleable.OtpEditText_oev_secondary_color, getResources().getColor(R.color.gray_scale));
