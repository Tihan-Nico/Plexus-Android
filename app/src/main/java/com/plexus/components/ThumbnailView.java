...
import com.plexus.glide.GlideBitmapListeningTarget;
import com.plexus.glide.GlideDrawableListeningTarget;
import com.plexus.slides.Slide;
import com.plexus.slides.SlideClickListener;
import com.plexus.slides.SlidesClickedListener;
...
public class ThumbnailView extends FrameLayout {
    ...
    private GlideRequest buildThumbnailGlideRequest(@NonNull GlideRequests glideRequests, @NonNull Slide slide) {
        ...
        else                      return request.apply(RequestOptions.errorOf(R.drawable.image_broken_variant));
    }
