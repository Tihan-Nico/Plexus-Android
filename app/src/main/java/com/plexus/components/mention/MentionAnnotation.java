package com.plexus.components.mention;
...
public final class MentionAnnotation {
    ...
    public static Annotation mentionAnnotationForRecipientId(@NonNull User id) {
        return new Annotation(MENTION_ANNOTATION, idToMentionAnnotationValue(id));
    }

    public static String idToMentionAnnotationValue(@NonNull User id) {
        return id.toString();
    }
        ...
        if (text instanceof Spanned) {
            ...
            return Stream.of(getMentionAnnotations(spanned))
                    .map(annotation -> {
                        ...
                        return new Mention(User.from(annotation.getValue()), spanStart, spanLength);
                    })
                    .toList();
        }
