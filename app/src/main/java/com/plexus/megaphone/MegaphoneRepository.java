...
import com.plexus.database.MegaphoneDatabase;
...
public class MegaphoneRepository {
    ...
    public MegaphoneRepository(@NonNull Application context) {
        ...
        this.executor = PlexusExecutors.SERIAL;
    ...
    @AnyThread
    public void markFinished(@NonNull Megaphones.Event event, @Nullable Runnable onComplete) {
        executor.execute(() -> {
    ...
    @WorkerThread
    private @NonNull
    MegaphoneRecord getRecord(@NonNull Megaphones.Event event) {
