...
import com.plexus.GlideRequest;
...
public class Megaphone {
    ...
    public @Nullable
    GlideRequest<Drawable> getImageRequest() {
        return imageRequest;
    }
    ...
    public @Nullable
    EventListener getButtonClickListener() {
        return buttonListener;
    }

    public @Nullable
    EventListener getSnoozeListener() {
    ...
    public @Nullable
    EventListener getSecondaryButtonClickListener() {
        return secondaryButtonListener;
    }

    public @Nullable
    EventListener getOnVisibleListener() {
    ...
    public static class Builder {
         ...
         */
        public @NonNull
        Builder setPriority(@NonNull Priority priority) {
            this.priority = priority;
            return this;
        }

        public @NonNull
        Builder enableSnooze(@Nullable EventListener listener) {
            this.canSnooze = true;
        ...
        public @NonNull
        Builder setBody(@StringRes int bodyRes) {
            this.bodyRes = bodyRes;
            return this;
        }

        public @NonNull
        Builder setImage(@DrawableRes int imageRes) {
            this.imageRes = imageRes;
            return this;
        }

        public @NonNull
        Builder setImageRequest(@Nullable GlideRequest<Drawable> imageRequest) {
            this.imageRequest = imageRequest;
            return this;
        }

        public @NonNull
        Builder setActionButton(@StringRes int buttonTextRes, @NonNull EventListener listener) {
        ...
        public @NonNull
        Builder setSecondaryButton(@StringRes int secondaryButtonTextRes, @NonNull EventListener listener) {
        ...
        public @NonNull
        Builder setOnVisibleListener(@Nullable EventListener listener) {
