...
import static com.plexus.blurhash.BlurHashUtil.linearTosRGB;
import static com.plexus.blurhash.BlurHashUtil.sRGBToLinear;
import static com.plexus.blurhash.BlurHashUtil.signPow;

class BlurHashDecoder {

    static @Nullable
    Bitmap decode(@Nullable String blurHash, int width, int height) {
        return decode(blurHash, width, height, 1f);
    }

    static @Nullable
    Bitmap decode(@Nullable String blurHash, int width, int height, double punch) {
