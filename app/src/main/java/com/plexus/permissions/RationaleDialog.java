package com.plexus.permissions;
...
public class RationaleDialog {
    ...
    public static AlertDialog.Builder createFor(@NonNull Context context, @NonNull String message, @DrawableRes int... drawables) {
        ...
        return new AlertDialog.Builder(context, ThemeUtil.isDarkTheme(context) ? R.style.Theme_Plexus_AlertDialog_Dark_Cornered : R.style.Theme_Plexus_AlertDialog_Light_Cornered)
                .setView(view);
    }
