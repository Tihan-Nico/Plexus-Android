...
import com.plexus.database.KeyValueDatabase;
 ...
 * <p>
 * Writes are enqueued on a separate executor, but writes are finished up meaning all write
 * should finish barring a native crash or the system killing us unexpectedly (i.e. a force-stop).
 */
public final class KeyValueStore implements KeyValueReader {
    ...
    public KeyValueStore(@NonNull Application application) {
        this.executor = PlexusExecutors.newCachedSingleThreadExecutor("lookout-KeyValueStore");
