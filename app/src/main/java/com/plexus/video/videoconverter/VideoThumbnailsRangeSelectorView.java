...
import com.plexus.utils.MemoryUnitFormat;
...
public final class VideoThumbnailsRangeSelectorView extends VideoThumbnailsView {
  ...
  private void init(final @Nullable AttributeSet attrs) {
    ...
    chevronLeft  = VectorDrawableCompat.create(getResources(), R.drawable.ic_chevron_left, null);
    chevronRight = VectorDrawableCompat.create(getResources(), R.drawable.ic_chevron_right, null);
