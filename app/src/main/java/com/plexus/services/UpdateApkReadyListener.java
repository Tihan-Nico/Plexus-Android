...
import com.plexus.utils.FileProviderUtil;
...
public class UpdateApkReadyListener extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (DownloadManager.ACTION_DOWNLOAD_COMPLETE.equals(intent.getAction())) {
            ...
            if (downloadId == PlexusPreferences.getUpdateApkDownloadId(context)) {
    ...
    private void displayInstallNotification(Context context, Uri uri) {
        ...
        Notification notification = new NotificationCompat.Builder(context, NotificationChannels.APP_UPDATES)
                .setOngoing(true)
                .setContentTitle(context.getString(R.string.UpdateApkReadyListener_plexus_Update))
                .setContentText(context.getString(R.string.UpdateApkReadyListener_a_new_version_of_plexus_is_available_tap_to_update))
    ...
    private @Nullable
    Uri getLocalUriForDownloadId(Context context, long downloadId) {
