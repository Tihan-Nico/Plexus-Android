...
public abstract class JobMigration {
    ...
    JobData migrate(@NonNull JobData jobData);
    ...
    public static class JobData {
        ...
        public @NonNull
        JobData withFactoryKey(@NonNull String newFactoryKey) {
            return new JobData(newFactoryKey, queueKey, data);
        }

        public @NonNull
        JobData withQueueKey(@Nullable String newQueueKey) {
            return new JobData(factoryKey, newQueueKey, data);
        }

        public @NonNull
        JobData withData(@NonNull Data newData) {
