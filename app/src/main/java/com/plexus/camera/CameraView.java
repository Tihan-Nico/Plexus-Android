...
public class CameraView extends ViewGroup {
    ...
    private volatile int cameraId = android.hardware.Camera.CameraInfo.CAMERA_FACING_BACK;
    ...
    public boolean isRearCamera() {
        return cameraId == android.hardware.Camera.CameraInfo.CAMERA_FACING_BACK;
    }

    public void flipCamera() {
        if (Camera.getNumberOfCameras() > 1) {
            cameraId = cameraId == android.hardware.Camera.CameraInfo.CAMERA_FACING_BACK
