...
public class GiphyActivity extends AppCompatActivity implements GiphyActivityToolbar.OnLayoutChangedListener,
    ...
    private void initializeToolbar() {
        ...
        toolbar.setPersistence(GiphyActivityToolbarPreferencesPersistence.fromContext(this));
