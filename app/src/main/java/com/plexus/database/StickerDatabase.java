...
import com.plexus.stickers.StickerPackInstallEvent;
...
public class StickerDatabase extends Database {
    ...
    private void broadcastInstallEvent(@NonNull String packId) {
        ...
        if (pack != null) {
            EventBus.getDefault().postSticky(new StickerPackInstallEvent(new DecryptableStreamUriLoader.DecryptableUri(pack.getCover().getUri())));
        }
    }
