...
import com.plexus.keyvalue.KeyValueDataSet;
import com.plexus.keyvalue.KeyValueStore;
...
/**
 * Persists data for the {@link KeyValueStore}.
 * <p>
 * This is it's own separate physical database, so it cannot do joins or queries with any other
 * tables.
 */
public class KeyValueDatabase extends SQLiteOpenHelper implements LookoutDatabase {

    private static final String TAG = Log.tag(KeyValueDatabase.class);

    private static final int DATABASE_VERSION = 3;
    private static final String DATABASE_NAME = "lookout-key-value.db";
    ...
    KeyValueDatabase getInstance(@NonNull Application context) {
        if (instance == null) {
