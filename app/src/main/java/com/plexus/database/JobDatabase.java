...
public class JobDatabase extends SQLiteOpenHelper implements LookoutDatabase {

    private static final String TAG = Log.tag(JobDatabase.class);

    private static final int DATABASE_VERSION = 1;
    private static final String DATABASE_NAME = "lookout-jobmanager.db";
    ...
    JobDatabase getInstance(@NonNull Application context) {
        if (instance == null) {
    ...
    private @NonNull
    JobSpec jobSpecFromCursor(@NonNull Cursor cursor) {
    ...
    private @NonNull
    ConstraintSpec constraintSpecFromCursor(@NonNull Cursor cursor) {
    ...
    private @NonNull
    DependencySpec dependencySpecFromCursor(@NonNull Cursor cursor) {
