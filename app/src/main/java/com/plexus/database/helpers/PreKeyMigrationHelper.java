...
import com.plexus.database.OneTimePreKeyDatabase;
import com.plexus.database.SignedPreKeyDatabase;
import com.plexus.protocol.InvalidMessageException;
import com.plexus.protocol.state.PreKeyRecord;
import com.plexus.protocol.state.SignedPreKeyRecord;
    ...
    static boolean migratePreKeys(Context context, SQLiteDatabase database) {
        ...
        if (oneTimePreKeyIndex.exists()) {
            try {
                ...
                PlexusPreferences.setNextPreKeyId(context, index.nextPreKeyId);
            } catch (IOException e) {
                Log.w(TAG, e);
            }
        }
        ...
        if (signedPreKeyIndex.exists()) {
            try {
                ...
                PlexusPreferences.setNextSignedPreKeyId(context, index.nextSignedPreKeyId);
                PlexusPreferences.setActiveSignedPreKeyId(context, index.activeSignedPreKeyId);
            } catch (IOException e) {
                Log.w(TAG, e);
            }
        }
