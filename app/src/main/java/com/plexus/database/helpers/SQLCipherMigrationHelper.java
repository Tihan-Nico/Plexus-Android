...
import com.plexus.R;
import com.plexus.crypto.AsymmetricMasterCipher;
...
import com.plexus.services.GenericForegroundService;
...
public class SQLCipherMigrationHelper {
    ...
    static void migratePlaintext(@NonNull Context context,
        ...
        int foregroundId = GenericForegroundService.startForegroundTask(context, context.getString(R.string.SQLCipherMigrationHelper_migrating_plexus_database)).getId();
        try {
    ...
    public static void migrateCiphertext(@NonNull Context context,
        ...
        try {
            ...
            PlexusPreferences.setNeedsSqlCipherMigration(context, false);
            modernDb.setTransactionSuccessful();
        } finally {
            modernDb.endTransaction();
            GenericForegroundService.stopForegroundTask(context, foregroundId);
