...
public final class PlexusCameraView extends FrameLayout {
    static final String TAG = Log.tag(PlexusCameraView.class);
    ...
    PlexusCameraXModule mCameraModule;
    ...
    public PlexusCameraView(@NonNull Context context) {
        this(context, null);
    }

    public PlexusCameraView(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PlexusCameraView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context, attrs);
    }

    @RequiresApi(21)
    public PlexusCameraView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr,
                            int defStyleRes) {
    ...
    private void init(Context context, @Nullable AttributeSet attrs) {
        ...
        mCameraModule = new PlexusCameraXModule(this);
